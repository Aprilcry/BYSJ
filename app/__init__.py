...
# 导入模型
from app.models import User, Ingredient, UserIngredient, Recipe, RecipeIngredient, RecipeView, SearchRecord, Post, Comment, UserActivity, CookingTip, IngredientCategoryMap

# 导入路由
from app.routes import auth, user, ingredient, recipe, recommendation, plaza
